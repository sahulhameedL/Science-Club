...
<body>
    <!-- No Data Modal -->
    <div class="no-data-modal" id="noDataModal">
        <div class="no-data-content">
            <div class="no-data-icon">📊</div>
            <h3 class="no-data-title">No Data Available</h3>
            <p class="no-data-message">This feature is currently under development. Please check back later for updates.</p>
            <button class="no-data-close" onclick="closeNoDataModal()">Close</button>
        </div>
    </div>
    ...
    <nav>
        <div class="nav-container">
            <div class="logo" onclick="showNoData()">
                <img src="svce.jpg" alt="SVCE Science Club Logo">
                <span>Science Club SVCE</span>
            </div>
            <ul class="nav-links">
                <li><a onclick="showNoData()">Home</a></li>
                <li><a onclick="showNoData()">Projects</a></li>
                <li><a onclick="showNoData()">Events</a></li>
                <li><a onclick="showNoData()">Join Us</a></li>
            </ul>
            <a onclick="showNoData()" class="join-btn">Become a Member</a>
        </div>
    </nav>
        ...
        <div class="hero-content">
            <div class="hero-text">
                ...
                <div class="hero-stats">
                    <div class="stat-item" onclick="showNoData()">
            ...
            <div class="hero-image">
                <img src="svce.jpg" alt="SVCE Science Club Students" onclick="showNoData()">
            </div>
        </div>
    </section>
    ...
    <section class="achievements" id="achievements">
        ...
        <div class="projects-grid">
            <div class="project-card" onclick="showNoData()">
                ...
                <div class="project-content">
                    ...
                    <div class="project-tags">
                        <span class="tag" onclick="event.stopPropagation(); showNoData()">Machine Learning</span>
                        <span class="tag" onclick="event.stopPropagation(); showNoData()">Healthcare</span>
                        <span class="tag" onclick="event.stopPropagation(); showNoData()">Python</span>
                    </div>
                </div>
            </div>
            ...
            <div class="project-card" onclick="showNoData()">
                ...
                <div class="project-content">
                    ...
                    <div class="project-tags">
                        <span class="tag" onclick="event.stopPropagation(); showNoData()">IoT</span>
                        <span class="tag" onclick="event.stopPropagation(); showNoData()">Renewable Energy</span>
                        <span class="tag" onclick="event.stopPropagation(); showNoData()">Arduino</span>
                    </div>
                </div>
            </div>
            ...
            <div class="project-card" onclick="showNoData()">
                ...
                <div class="project-content">
                    ...
                    <div class="project-tags">
                        <span class="tag" onclick="event.stopPropagation(); showNoData()">Quantum Computing</span>
                        <span class="tag" onclick="event.stopPropagation(); showNoData()">Research</span>
                        <span class="tag" onclick="event.stopPropagation(); showNoData()">Qiskit</span>
                    </div>
                </div>
            </div>
            ...
            <div class="project-card" onclick="showNoData()">
                ...
                <div class="project-content">
                    ...
                    <div class="project-tags">
                        <span class="tag" onclick="event.stopPropagation(); showNoData()">Robotics</span>
                        <span class="tag" onclick="event.stopPropagation(); showNoData()">Computer Vision</span>
                        <span class="tag" onclick="event.stopPropagation(); showNoData()">ROS</span>
                    </div>
                </div>
            </div>
            ...
            <div class="project-card" onclick="showNoData()">
                ...
                <div class="project-content">
                    ...
                    <div class="project-tags">
                        <span class="tag" onclick="event.stopPropagation(); showNoData()">Biotechnology</span>
                        <span class="tag" onclick="event.stopPropagation(); showNoData()">Sustainability</span>
                        <span class="tag" onclick="event.stopPropagation(); showNoData()">Chemistry</span>
                    </div>
                </div>
            </div>
            ...
            <div class="project-card" onclick="showNoData()">
                ...
                <div class="project-content">
                    ...
                    <div class="project-tags">
                        <span class="tag" onclick="event.stopPropagation(); showNoData()">Space Tech</span>
                        <span class="tag" onclick="event.stopPropagation(); showNoData()">Electronics</span>
                        <span class="tag" onclick="event.stopPropagation(); showNoData()">ISRO</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="events-grid">
                <div class="event-card">
                    <div class="event-date">
                        <div class="date-box" onclick="showNoData()">
                    ...
                    <a onclick="showNoData()" class="register-btn">Register Now</a>
                </div>
    ...
    <section class="membership" id="membership">
        ...
        <div class="membership-content">
            ...
            <div class="benefits-grid">
                <div class="benefit-item" onclick="showNoData()">
            ...
            <a onclick="showNoData()" class="cta-button">Start Your Scientific Journey Today</a>
        </div>
    </section>
    ...
    <footer>
        <div class="footer-content">
            ...
            <div class="social-links">
                <a onclick="showNoData()">LinkedIn</a>
                <a onclick="showNoData()">Instagram</a>
                <a onclick="showNoData()">Twitter</a>
                <a onclick="showNoData()">YouTube</a>
            </div>
        </div>
    </footer>

    <script>
        // Function to show No Data modal
        function showNoData() {
        ...
        // Function to close No Data modal
        ...
        // Prevent all anchor tag default behavior
